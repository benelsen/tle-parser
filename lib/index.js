 ...
 * @property {number} arg_pericenter       Argument of Perigee [degrees]
 * @property {number} mean_anomaly         Mean Anomaly [degrees]
 * @property {number} mean_motion          Mean Motion [revolutions/day]
 * @property {number} mean_motion_dot      First time derivative of the Mean Motion
 * @property {number} mean_motion_dot_dot  Second time derivative of the Mean Motion
 * @property {number} b_star               B* drag term
